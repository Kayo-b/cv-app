...
export class ProfessionalExp extends Component {
    ...
    <input  onChange={this.props.input} id={this.props.id} className="profExp" name="from" type="text" placeholder='From' onFocus={e => e.target.type = "date"}></input>
    <input  onChange={this.props.input} id={this.props.id} className="profExp" name="to" type="text" placeholder='To' onFocus={e => e.target.type = "date"}></input>
    <textarea cols='60' rows='8' onChange={this.props.input} id={this.props.id} className="profExp" name="description" type="text" placeholder='Job Description...'></textarea>
    </div>
