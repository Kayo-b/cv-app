...
export class ProfessionalExp extends Component {
    ...
    <input  onChange={this.props.input} id={this.props.id} className="profExp" name="from" type="number" placeholder='From'></input>
    <input  onChange={this.props.input} id={this.props.id} className="profExp" name="to" type="number" placeholder='To'></input>
